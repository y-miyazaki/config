---
name: loop-report-tech-debt
description: >-
  Discover and classify technical debt from loop-injected mechanical signals,
  then publish a structured report under docs/report/report-tech-debt/. Use when loop
  ...
  (e.g. on-loop-report-tech-debt.yaml cron); never user-invoked.
license: Apache-2.0
metadata:
  author: y-miyazaki
  version: "1.2.2"
