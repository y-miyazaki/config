...
- **Overview contract:** trigger → substance → action; write enough detail for a reviewer without opening the diff; name hint kinds and touched paths; omit level, Target, and boilerplate
