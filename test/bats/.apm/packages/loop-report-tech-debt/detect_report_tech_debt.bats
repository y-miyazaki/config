...
# Tests for .apm/packages/loop-report-tech-debt/.apm/skills/loop-report-tech-debt/scripts/detect_report_tech_debt.sh
#
# Use cases:
...
DETECT_SCRIPT="$(apm_skill_script_path loop-report-tech-debt detect_report_tech_debt.sh)"
