...
# Tests for .apm/packages/repo-maintenance/.apm/skills/ci-sweeper/scripts/update_run_ledger.sh
...
LEDGER_SCRIPT="$(apm_skill_script_path ci-sweeper update_run_ledger.sh)"
