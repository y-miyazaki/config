...
# Tests for .apm/packages/repo-maintenance/.apm/skills/ci-sweeper/scripts/detect_ci_failures.sh
...
DETECT_SCRIPT="$(apm_skill_script_path ci-sweeper detect_ci_failures.sh)"
...
setup() {
    ...
    bats_source_apm_skill ci-sweeper detect_ci_failures.sh
