...
# Tests for .apm/packages/common/.apm/skills/issue-triage/scripts/label_fsm.sh
...
LABEL_FSM_LIB="${BATS_WORKSPACE_ROOT:-}/.apm/packages/common/.apm/skills/issue-triage/scripts/label_fsm.sh"
LABELS_JSON="${BATS_WORKSPACE_ROOT:-}/.apm/packages/common/.apm/skills/issue-triage/scripts/labels.json"
