...
# Tests for .apm/packages/common/.apm/skills/issue-triage/scripts/issue_comment.sh
...
setup() {
    ...
    COMMENT_SCRIPT="$(apm_skill_script_path issue-triage issue_comment.sh)"
    install_issue_comment_gh_mock
