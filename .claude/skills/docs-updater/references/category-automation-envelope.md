...
- **Overview contract:** trigger → substance → action; write enough detail for a reviewer without opening the diff; name finding types and affected doc paths; omit level, Target, and boilerplate
