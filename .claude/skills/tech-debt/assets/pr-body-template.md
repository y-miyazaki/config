<!--
Canonical PR-facing template for loop-tech-debt.
...
<!--
  GOOD: Debt scan over abc..def found no Critical/High items; recorded 21 Watch signals in docs/report/tech-debt/2026-07-21.md.
...
| ------------------------------------- | ------------------------------ | -------------------------- |
| `docs/report/tech-debt/YYYY-MM-DD.md` | <dominant categories / counts> | <report structure summary> |
