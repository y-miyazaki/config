...
- Modify: `.apm/packages/docs-updater/.apm/skills/docs-updater/references/common-output-format.md`
...
- [x] waza eval: docs-updater, loop-ci-sweeper, loop-changelog, loop-tech-debt (100% each; eval.yaml v1.2 + task prompt contract suffix)
