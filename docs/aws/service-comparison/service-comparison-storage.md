...
| 主要サービス制限     | 64TB/ボリューム、IOPS 256,000 (io2 BE)、スナップショット 100,000/リージョン ([Quotas](https://docs.aws.amazon.com/ebs/latest/userguide/ebs-resource-quotas.html)) | ファイルサイズ 52TB、スループット 10GB/s ([Quotas](https://docs.aws.amazon.com/efs/latest/ug/limits.html)) | オブジェクト 5TB、PUT 3,500 RPS/プレフィックス、GET 5,500 RPS/プレフィックス ([Quotas](https://docs.aws.amazon.com/AmazonS3/latest/userguide/optimizing-performance.html)) |
...
| 主要サービス制限     | ファイル 52TB、スループット 10GB/s ([Quotas](https://docs.aws.amazon.com/efs/latest/ug/limits.html)) | S3 制限に準拠、書き込み可視性 ~60秒 ([Quotas](https://docs.aws.amazon.com/AmazonS3/latest/userguide/optimizing-performance.html)) | ファイルシステム容量 プロビジョン依存 ([Quotas](https://docs.aws.amazon.com/fsx/latest/LustreGuide/limits.html)) | ボリューム 512TB、SVM 24/ファイルシステム ([Quotas](https://docs.aws.amazon.com/fsx/latest/ONTAPGuide/limits.html)) |
...
| 主要サービス制限     | オブジェクト 5TB、PUT 3,500 RPS/プレフィックス ([Quotas](https://docs.aws.amazon.com/AmazonS3/latest/userguide/optimizing-performance.html)) | 最小保存 30日、最小サイズ 128KB ([Quotas](https://docs.aws.amazon.com/AmazonS3/latest/userguide/optimizing-performance.html)) | 最小保存 90日、最小サイズ 128KB ([Quotas](https://docs.aws.amazon.com/AmazonS3/latest/userguide/optimizing-performance.html)) | 最小保存 180日、取出 12-48時間 ([Quotas](https://docs.aws.amazon.com/AmazonS3/latest/userguide/optimizing-performance.html)) |
