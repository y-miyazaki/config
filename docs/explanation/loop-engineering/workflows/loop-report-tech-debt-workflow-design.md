...
| `detect_script`                | Domain detect script path.                                                                                                                                                                                                | `.agents/skills/report-tech-debt/scripts/detect_report_tech_debt.sh`                       |
...
| `skill_name`                   | Skill package to invoke.                                                                                                                                                                                                  | `report-tech-debt`                                                                         |
