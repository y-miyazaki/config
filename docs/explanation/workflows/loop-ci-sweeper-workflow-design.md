...
| `detect_permissions_profile`                                | Routes detect through `detect-full-github` (`actions: read`, `pull-requests: read`); caller `permissions` must include `actions: read`. | `full-github`                                                                                            |
