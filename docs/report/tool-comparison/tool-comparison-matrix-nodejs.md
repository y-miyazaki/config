...
| 日付       | 内容                                                                 |
| ---------- | -------------------------------------------------------------------- |
| 2026-06-17 | 全般最新化: Biome v2.5.0 HTML/SVG対応反映、Formatter推奨をBiomeに変更 |
...
- [Linter: Biome vs deno lint vs ESLint](#linter-biome-vs-deno-lint-vs-eslint)
  - [Guidelines](#guidelines)
- [Formatter: Biome vs dprint vs Prettier](#formatter-biome-vs-dprint-vs-prettier)
