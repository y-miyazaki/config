...
- After changes, prioritize running validate.sh from [shell-script-validation Skill](../../apm_modules/_local/shell-script/.apm/skills/shell-script-validation/SKILL.md).
...
**Detailed guide**: See [shell-script-validation Skill](../../apm_modules/_local/shell-script/.apm/skills/shell-script-validation/SKILL.md).
