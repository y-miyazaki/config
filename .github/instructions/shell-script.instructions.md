...
- DOC-03 (SHOULD): Function Separators and Comments
  - Check: Do functions have `#######` separator and Arguments/Global Variables/Returns sections?
...
- FUNC-02 (SHOULD): Standardize parse_arguments
  - Check: Is parse_arguments standardized with while + case statements supporting short and long options?
